...
#
# .. your code here ..
X=pd.read_csv(r'D:\python\DAT210x-master\Module5\Datasets\wheat.data')
...
#X = X.groupby("id").transform(lambda n: n.fillna(x.mean())
...
print(accuracy_score(y_test,p,normalize=False))
