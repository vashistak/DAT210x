...
# .. your code here ..
import pandas as pd
df=pd.read_csv(r'D:\python\DAT210x-master\Module5\Datasets\breast-cancer-wisconsin.data',header=None,
...
df=df.drop(labels=['sample', 'status'], axis = 1, inplace = True)
print(df)
#
...
df_train,df_test,y_train,y_test= train_test_split(df, y, test_size=0.5, random_state=7)
...
# .. your code here ..
df1 = model.fit(T)
df_train=df1.tranform(df_train)
df_test=df1.tranform(df_test)
...
plotDecisionBoundary(knn, df_test, y_test)
