...
df=pd.read_csv(r'Crimes_-_2001_to_present.csv')
print(df)
#exit()
def doKMeans(df):
  #
...
#
# .. your code here ..
df1=pd.read_csv(r'Crimes_-_2001_to_present.csv')
...
df1['Date'] = df1['Date'].apply(lambda x:  dt.datetime.strptime(x,'%m/%d/%Y %H:%M:%S %p'))
print(df1.dtypes)
