...
#
# .. your code here ..
X=pd.read_csv(r'D:\python\DAT210x-master\Module5\Datasets\life_expectancy.csv',sep='\t')
...
print (" 2014 White male Life Expectancy: ", X.WhiteMale[X.Year==2014])
...
X1_train=X.Year[X.Year<1986]

y1_train=X.BlackFemale[X.Year < 1986]
