...
plt.suptitle('area,perimeter and asymmetry')
ax=fig.add_subplot(111, projection='3d')
ax.set_xlabel('area')
ax.set_ylabel('perimeter')
ax.set_zlabel('asymmetry')
ax.scatter(df.area,df.asymmetry,df.perimeter,c='r', marker='o')
...
# 
# .. your code here ..
plt.suptitle('width,groove and length')
ax=fig.add_subplot(111, projection='3d')
ax.set_xlabel('width')
ax.set_ylabel('groove')
ax.set_zlabel('length')
ax.scatter(df.groove,df.length,df.width,c='g', marker='^')
