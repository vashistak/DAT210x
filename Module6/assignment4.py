...
#
# .. your code here ..
X=pd.read_csv(r'D:\python\udacity\Module6\Datasets\wheat.data',index_col = 0)
...
tre = tree.DecisionTreeClassifier(max_depth=5,random_state=2)
...
benchmark(tre, X_train, X_test, y_train, y_test, 'Decision Tree')
drawPlots(tre, X_train, X_test, y_train, y_test, 'Decision Tree')
